...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-9 p-0">
                <h1 class="fs-2 text-end fw-bold m-0">Handover Check List <span class="fs-5">Lista de verificación de
                        entrega</span></h1>
            </div>
    ...
    <form name="vehicleform" id="vehicleform" method="post" action="{{ route('vehicleform.store') }}"
        ...
        <div class="container border border-dark">
            ...
            <div class="row">
                ...
                <div class="col-sm-3 p-0 border border-dark">
                    <input name="v217" type="text" class="form-control border-0 rounded-0 text-center " id="chasis"
                        placeholder="" value="{{ $request->chasis }}">
                </div>
                <div class="col-sm-3 p-0 border border-dark">
                    <input name="v218" type="date" class="form-control border-0 rounded-0" placeholder="">
                </div>
                <div class="col-sm-3 p-0 border border-dark">
                    <input name="v219" type="text" class="form-control border-0 rounded-0 text-center "
                        placeholder="">
                </div>
            </div>
            <div class="row">
                <div class="col-12 border border-dark">
                    <p>*Company: distributor, insurance company, shipping agent, etc. Empresa: distribuidor, compañía de
                        seguros, agente marítimo, etc.</p>
                    <p>External inspection Inspección externa</p>
                    <p>Circle the part of vehicle that has problem or defect. Encierre en un círculo la parte del vehículo
                        que tiene el problema o defecto.</p>
                </div>
            </div>
            <!-- ------------>
            <div class="row">
            ...
            <div class="row border border-dark">
                <div class="col-12">
                    <label for="" class="form-label">► Describe each problem or defect, and indicate the
                        completion state on the right side after parts replacement or repair. Describa cada problema o
                        defecto e indique el estado de finalización en el lado derecho después del reemplazo o reparación de
                        piezas</label>
                </div>
                <div class="col-6">
                ...
                <div class="col-12 mb-3">
                    <label for="" class="form-label">► Write down the items that new cars should have had but are
                        missing. Anote los artículos que deberían haber tenido los autos nuevos pero faltan</label>
                    <textarea class="form-control rounded-0 border border-dark" id="exampleFormControlTextarea1" rows="3"></textarea>
                </div>
                <div class="col-12 mb-4">
                    <p>※ Vehicle-mounted parts (vary with vehicle type and optional item) Piezas montadas en el vehículo
                        (varían según el tipo de vehículo y el artículo opcional)</p>
                    <p>Owner’s Manual, tool kit, cigarette lighter, jack, remote controller, spare wheel, etc. Manual de
                        instrucciones, juego de herramientas, encendedor, gato, mando a distancia, rueda de repuesto, etc.
                    </p>
                </div>
                <div class="col-6">
                    <center>
                        <input name="v11" value="{{ auth()->user()->name }}" type="text"
                            class="form-control rounded-0 border-top-0 border-end-0 border-start-0 border-dark mb-2 text-center w-75"
                            placeholder="" aria-label="" aria-describedby="">
        ...
        <div class="container border border-dark">
            <div class="row border border-dark">
                ...
                <div class="col-6">
                    <div class="input-group">
                        ...
                        <input name="v13" type="text"
                            class="form-control rounded-0 border-top-0 border-end-0 border-start-0 border-dark"
                            placeholder="" aria-label="" aria-describedby="">
                    </div>
                    <div class="input-group">
                        <span class="input-group-text bg-transparent border-0 ps-0">(BOL).: </span>
                        <input name="v220" type="text" class="form-control rounded-0 border-0" placeholder=""
            ...
            <div class="row border border-dark">
                <div class="col-1 border-end border-dark d-flex align-items-center">
                    <div class="input-group d-block">
                        ...
                        <input name="v14" type="text" class="form-control w-100 ps-0 border-0 rounded-0"
                            placeholder="1" aria-label="" aria-describedby="">
                    </div>
                </div>
                <div class="col-1 border-start border-end border-dark d-flex align-items-center">
                    <div class="input-group d-block">
                        ...
                        <input name="v15" type="text" class="form-control w-100 ps-0 border-0 rounded-0"
                            placeholder="" value="{{ $request->modelo }}" aria-label="" aria-describedby="">
                    </div>
                </div>
            ...
            <div class="row border border-dark">
                <div class="col-4 border-end border-dark d-flex align-items-center pe-0">
                    <div class="input-group">
                        ...
                        <input name="v17" type="number"
                            class="form-control rounded-0 border-0 border-start border-dark" placeholder=""
                            aria-label="" aria-describedby="">
                    </div>
                </div>
                <div class="col-8 border-start border-dark d-flex align-items-center p-0" id="phoneInput">
                    <div class="input-group h-100">
                        <input name="v18" value="{{ $request->chasis }}" type="text"
                            class="form-control border-0 p-0 text-center letter" placeholder="" aria-label="">
                ...
                <div class="col-11 col-sm-9 border-start border-dark">
                    ...
                    <div style="height:200px" class="row">
                        <div class="col-1 border-end border-dark  ">
                            <div style="transform: rotate(90deg);transform-origin: top left;width: 180px;margin-left: 30px; margin-top: 5px;"
                                class="lh-1">Vehicle No</div>
                        </div>
                        <div class="col-1 border-start border-end border-start border-dark ">
                            <p style="transform: rotate(90deg);transform-origin: top left;width: 180px;margin-left: 30px; margin-top: 5px;"
                                class="lh-1">Defect location ubicacion del defecto</p>
                        </div>
                        <div class="col-1 border-start border-end border-start border-dark ">
                            <p style="transform: rotate(90deg);transform-origin: top left;width: 180px;margin-left: 30px; margin-top: 5px;"
                                class="lh-1">Defect code código del defecto</p>
                        </div>
                        <div class="col-1 border-start border-end border-start border-dark ">
                            <p style="transform: rotate(90deg);transform-origin: top left;width: 180px;margin-left: 30px; margin-top: 5px;"
                                class="lh-1">Defect degree and damage area grado del defecto y area del daño</p>
                        </div>
                        <div class="col-1 border-start border-end border-start border-dark ">
                            <p style="transform: rotate(90deg);transform-origin: top left;width: 180px;margin-left: 30px; margin-top: 5px;"
                                class="lh-1">Vehicle No</p>
                        </div>
                        <div class="col-1 border-start border-end border-start border-dark ">
                            <p style="transform: rotate(90deg);transform-origin: top left;width: 180px;margin-left: 30px; margin-top: 5px;"
                                class="lh-1">Defect location</p>
                        </div>
                        <div class="col-1 border-start border-end border-start border-dark ">
                            <p style="transform: rotate(90deg);transform-origin: top left;width: 180px;margin-left: 30px; margin-top: 5px;"
                                class="lh-1">Defect code</p>
                        </div>
                        <div class="col-1 border-start border-end border-start border-dark ">
                            <p style="transform: rotate(90deg);transform-origin: top left;width: 180px;margin-left: 30px; margin-top: 5px;"
                                class="lh-1">Defect degree and damage area</p>
                        </div>
                        <div class="col-1 border-start border-end border-start border-dark ">
                            <p style="transform: rotate(90deg);transform-origin: top left;width: 180px;margin-left: 30px; margin-top: 5px;"
                                class="lh-1">Vehicle No</p>
                ...
                <div class="col-12 col-sm-9 border-start border-dark">
                    <div class="row">
                        <div class="col-1  border-end border-dark" style="padding-left: 1px;padding-right: 1px; ">
                            <textarea name="v48" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v49" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v50" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v51" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v52" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v53" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v54" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v55" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v56" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v57" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v58" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start  border-dark" style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v59" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="row border border-dark">
                ...
                <div class="col-12 col-sm-9 border-start border-dark">
                    <div class="row">
                        <div class="col-1  border-end border-dark" style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v60" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v61" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v62" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v63" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v64" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v65" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v66" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v67" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v68" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v69" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v70" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start  border-dark" style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v71" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="row border border-dark">
                ...
                <div class="col-12 col-sm-9 border-start border-dark">
                    <div class="row">
                        <div class="col-1  border-end border-dark" style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v72" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v73" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v74" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v75" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v76" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v77" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v78" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v79" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v80" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v81" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v82" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start  border-dark" style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v83" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="row border border-dark">
                ...
                <div class="col-12 col-sm-9 border-start border-dark">
                    <div class="row">
                        <div class="col-1  border-end border-dark" style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v84" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v85" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v86" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v87" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v88" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v89" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v90" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v91" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v221" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v92" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v93" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start  border-dark" style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v94" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="row border border-dark">
                ...
                <div class="col-12 col-sm-9 border-start border-dark">
                    <div class="row">
                        <div class="col-1  border-end border-dark" style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v95" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v96" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v97" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v98" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v99" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v100" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v222" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v101" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v102" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v103" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v104" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start  border-dark" style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v105" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="row border border-dark">
                ...
                <div class="col-12 col-sm-9 border-start border-dark">
                    <div class="row">
                        <div class="col-1  border-end border-dark" style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v106" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v107" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v108" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v109" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v110" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v111" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v112" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v223" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v113" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v114" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v115" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start  border-dark" style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v116" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="row border border-dark">
                ...
                <div class="col-12 col-sm-9 border-start border-dark">
                    <div class="row">
                        <div class="col-1  border-end border-dark" style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v117" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v118" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v119" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v120" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v121" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v122" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v123" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v124" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v125" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v126" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v127" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start  border-dark" style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v128" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="row border border-dark">
                ...
                <div class="col-12 col-sm-9 border-start border-dark">
                    <div class="row">
                        <div class="col-1  border-end border-dark" style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v129" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v130" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v131" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v132" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v133" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v134" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v135" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v136" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v137" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v138" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v139" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start  border-dark" style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v140" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="row border border-dark">
                ...
                <div class="col-12 col-sm-9 border-start border-dark">
                    <div class="row">
                        <div class="col-1  border-end border-dark" style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v141" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v142" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v143" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v144" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v145" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v146" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v147" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v148" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v149" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v150" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start border-end border-dark"
                            style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v151" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                        <div class="col-1 border-start  border-dark" style="padding-left: 1px;padding-right: 1px;">
                            <textarea name="v152" class="form-control" type="text" value=""
                                style="padding-left: 1px;padding-right: 1px;  font-size: 10px;"></textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="row border border-dark">
                <div class="col-12 col-sm-3 border-end border-dark d-flex align-items-center text-center">
                    <p class="m-0 text-start lh-sm">Confirmed by delivery side:<br>Confirmado por la parte que
                        entrega<br>Signature firma:</p>
                </div>
            ...
            <div class="row border border-dark">
                <div class="col-12 col-sm-3 border-end border-dark d-flex align-items-center text-center">
                    <p class="m-0 text-start lh-sm">Confirmed by receiving party:<br>Confirmado por la parte que
                        recibe<br>Signature firma:</p>
                </div>
                <div class="col-12 col-sm-9 border-start border-dark d-flex align-items-center text-center p-0">
            ...
            <div class="row border border-dark">
                ...
                <div class="col-12 col-sm-9 border-start border-dark d-flex align-items-center text-center p-0">
                    <input name="v154" type="date" class="form-control rounded-0 border-0 h-100"
                        placeholder="">
                </div>
            </div>
        </div>
            ...
            <div class="row border border-top-0 border-dark">
                <div class="col-1 border-end border-dark d-flex align-items-center p-3 text-center ">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle">
                            <input name="v155" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark  mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v156" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark  mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle">
                            <input name="v157" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                </div>
            ...
            <div class="row border border-dark">
                <div class="col-1 border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v158" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v159" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v160" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
            ...
            <div class="row border border-dark">
                <div class="col-1 border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v161" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle">
                            <input name="v162" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v163" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
            ...
            <div class="row border border-dark">
                <div class="col-1 border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v164" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v165" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v166" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
            ...
            <div class="row border border-dark">
                <div class="col-1 border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v167" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v168" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v169" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-3 border-start border-dark d-flex align-items-center">
                    <p class="lh-base m-0">Front lamp LH and left steering lamp luz delantera y luz direccional izquierda
                    </p>
                </div>
            </div>
            <!-- 6 - 27 - 47  -->
            <div class="row border border-dark">
                <div class="col-1 border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v170" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v171" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v172" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-3 border-start border-dark d-flex align-items-center">
                    <p class="lh-base m-0">Front lamp RH and right steering lamp luz delantera y luz direccional derecha
                    </p>
                </div>
            </div>
            <!-- 7 - 28 - 48  -->
            <div class="row border border-dark">
                <div class="col-1 border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v173" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v174" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v175" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
            ...
            <div class="row border border-dark">
                <div class="col-1 border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v176" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v177" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v178" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
            ...
            <div class="row border border-dark">
                <div class="col-1 border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v179" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v180" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v181" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
            ...
            <div class="row border border-dark">
                <div class="col-1 border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v182" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v183" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v184" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
            ...
            <div class="row border border-dark">
                <div class="col-1 border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v185" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v186" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v187" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
            ...
            <div class="row border border-dark">
                <div class="col-1 border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v188" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v189" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v190" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
            ...
            <div class="row border border-dark">
                <div class="col-1 border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v191" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v192" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v193" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-3 border-start border-dark d-flex align-items-center">
                    <p class="lh-base m-0">Headlining (or sunroof if installed) Revestimiento del techo (o techo corredizo
                        si está instalado)</p>
                </div>
            </div>
            <!-- 14 - 35 - 55 fbdfbdf -->
            <div class="row border border-dark">
                <div class="col-1 border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v194" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v195" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v196" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
            ...
            <div class="row border border-dark">
                <div class="col-1 border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v197" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v198" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v199" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
            ...
            <div class="row border border-dark">
                <div class="col-1 border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v200" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v201" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v202" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
            ...
            <div class="row border border-dark">
                <div class="col-1 border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v203" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v204" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v205" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
            ...
            <div class="row border border-dark">
                <div class="col-1 border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v206" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v207" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v208" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
            ...
            <div class="row border border-dark">
                <div class="col-1 border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v209" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v210" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v211" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
            ...
            <div class="row border border-dark">
                <div class="col-1 border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v212" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v213" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
                ...
                <div class="col-1 border-start border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v214" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
            ...
            <div class="row border border-dark">
                <div class="col-1 border-end border-dark d-flex align-items-center p-3 text-center">
                    <div class="position-relative d-flex align-items-center w-100 h-100">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle ">
                            <input name="v215" style="width: 40px !important;"
                                class="form-check-input rounded-circle border-dark w-50 mt-0 check-r" type="checkbox"
                                value="1">
                        </div>
                    </div>
        ...
        <div class="container border border-dark">
            <div class="row border-start border-end border-dark">
                ...
                <div class="col-11 border border-end-0 border-dark">
                    <p class="m-0">Panel replacement (not inferior to production quality) Reemplazo del panel (no
                        inferior a la calidad de producción)</p>
                </div>
                <div class="col-1 border border-start-0 border-dark">
                    <p class="m-0">4. </p>
                </div>
        ...
        <div class="container">
            <div style="height: 100px;" class="row ">
                <div class="h-100 col-md-12 d-flex align-items-center p-1 text-center">
                    <button onclick="allfuncion()" type="submit" class="btn btn-primary mh-100"
                        style="width: 200px; height: 100px;">Guardar</button>
                </div>
            </div>
        </div>
    </form>
