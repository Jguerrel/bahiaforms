...
<form name="vehicleform" id="vehicleform" method="post" action="{{ route('vehicleform.store') }}">
    @csrf
    <input type="hidden" value="{{$form->marca}}" id="marca" name="marca">
    <input type="hidden" value="{{$form->modelo}}" id="modelo" name="modelo">
    <input type="hidden" value="{{$form->motor}}" id="motor" name="motor">
    <input type="hidden" value="{{$form->chasis}}" id="chasis" name="chasis">
    <input type="hidden" value="{{$form->anio}}" id="anio" name="anio">
    <input type="hidden" value="{{$form->version}}" id="version" name="version">
    <input type="hidden" value="{{$form->colorexterior}}" id="colorexterior" name="colorexterior">
    <input type="hidden" value="{{$form->colorinterior}}" id="colorinterior" name="colorinterior">
    ...
    <div class="container border border-dark ">
        ...
        <div class="row border border-dark ">
            <div class="col-sm-3 border-end border-dark align-items-center p-1 text-start ">
                <input name="v114" value="{{$form->chasis}}" type="date" class=" form-control border-0 p-0 text-center letter w-100" placeholder="" aria-label="">
            </div>

            <div class="col-sm-2 border-end border-dark align-items-center p-1 text-center">
                <input name="v115" value="{{$form->modelo}}" type="text" class="h-100 form-control border-0 p-0 text-center letter" placeholder="" aria-label="">
            </div>
            <div class="col-sm-2 border-end border-dark align-items-center p-1 text-center">
                <input name="v116" type="text" class="h-100 form-control border-0 p-0 text-center letter" placeholder="" aria-label="">
            </div>
            <div class="col-sm-3  border-end border-dark align-items-center p-1 text-center">
                <input name="v117" value="{{$form->chasis}}" type="text" class="h-100 form-control border-0 p-0 text-center letter" placeholder="" aria-label="">
            </div>
            <div class="col-sm-2 border-end border-dark align-items-center p-1 text-center">
                <input name="v118" value="{{$formrequest['v118']}}" type="date" class=" form-control border-0 p-0 text-center letter w-100" placeholder="" aria-label="">
            </div>
        </div>
    </div>
    <br>
        ...
        <div class="row border border-dark ">
            ...
            <div class="col-sm-2 border-end border-dark align-items-center p-0 m-0 text-start ">
                ...
                <div style="height: 50px;" class="row border-bottom border-dark w-100 m-0">
                    <div class="col">
                        <input name="v119" type="date" class=" form-control border-0 p-0 text-center letter w-100" placeholder="" aria-label="">
                    </div>
                </div>
                <div style="height: 40px;" class="row border-bottom border-dark w-100 m-0">
                    <div class="col">
                ...
                <div style="height: 40px;" class="row border-bottom border-dark w-100 m-0">
                    <div class="col">
                        <input name="v120" type="text" class="h-100 form-control border-0 p-0 text-center letter" placeholder="" aria-label="">
                    </div>
                </div>
                <div style="height: 40px;" class="row border-bottom border-dark w-100 m-0">
                    <div class="col">
            ...
            <div class="col-sm-2 border-end border-dark  p-0">
                    ...
                    <div class="col m-0 p-0">
                        <div class="row h-50 w-100 p-0 m-0">
                            <div class="col-6 border-bottom border-end border-dark">
                                <input class="form-control form-control-sm " type="text" name="v200" placeholder="LF">
                            </div>
                            <div class="col-6 border-bottom border-dark">
                                <input class="form-control form-control-sm" type="text" name="v201" placeholder="RF">
                            </div>
                        </div>
                        <div class="row h-50 border-bottom border-dark w-100 p-0 m-0">
                            <div class="col-6 border-end border-dark">
                                <input class="form-control form-control-sm" type="text" name="v202" placeholder="LR">
                            </div>
                            <div class="col-6 ">
                                <input class="form-control form-control-sm" type="text" name="v203" placeholder="RR">
                            </div>
                        </div>
                    </div>
                </div>
                <div style="height: 40px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    ...
                    <div class="col   m-0 p-0">
                        <input name="v121" type="text" class="w-100 form-control border-1 p-0  " placeholder="" aria-label="">
                    </div>
                </div>
                <div style="height: 50px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    ...
                    <div class="col   m-0 p-0">
                        <input name="v122" type="text" class="w-100 form-control border-1 p-0  " placeholder="" aria-label="">
                    </div>
                </div>
                <div style="height: 40px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    <div class="col ">
    ...
    <div class="container border border-dark">
        ...
        <div class="row border border-dark ">
            ...
            <div class="col-sm-2 border-end border-dark align-items-center p-0 -m-0 text-start ">
                ...
                <div style="height: 40px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    <div class="col">
                        <input name="v125" type="date" class=" form-control border-0 p-0 text-center letter w-100" placeholder="" aria-label="">
                    </div>
                </div>
                ...
                <div style="height: 75px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    <div class="col">
                        <input name="v126" type="text" class="h-100 form-control border-0 p-0 text-center letter" placeholder="" aria-label="">
                    </div>
                </div>
                <div style="height: 75px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    <div class="col">
            ...
            <div class="col-sm-2 border-end border-dark  p-0 m-0">
                ...
                <div style="height: 40px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    ...
                    <div class="col   m-0 p-0">
                        <input name="v127" type="text" class="w-100 form-control border-1 p-0  " placeholder="" aria-label="">
                    </div>
                </div>
                ...
                <div style="height: 75px;" class="row w-100 m-0 p-0">
                    <div class="col m-0 p-0 h-100">
                        <div class="row h-50 w-100 p-0 m-0">
                            <div class="col-6 border-bottom border-end border-dark">
                                <input class="form-control form-control-sm" type="text" name="v204" placeholder="LF">
                            </div>
                            <div class="col-6 border-bottom border-dark">
                                <input class="form-control form-control-sm" type="text" name="v205" placeholder="RF">
                            </div>
                        </div>
                        <div class="row h-50 border-bottom border-dark w-100 p-0 m-0">
                            <div class="col-6 border-end border-dark">
                                <input class="form-control form-control-sm" type="text" name="v206" placeholder="LR">
                            </div>
                            <div class="col-6 ">
                                <input class="form-control form-control-sm" type="text" name="v207" placeholder="RR">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row border border-dark ">
            ...
            <div class="col-sm-2 border-end border-dark align-items-center p-0 -m-0 text-start ">
                ...
                <div style="height: 40px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    <div class="col">
                        <input name="v128" type="date" class=" form-control border-0 p-0 text-center letter w-100" placeholder="" aria-label="">
                    </div>
                </div>
                <div style="height: 40px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    <div class="col">
                        <input name="v129" type="date" class=" form-control border-0 p-0 text-center letter w-100" placeholder="" aria-label="">
                    </div>
                </div>
                <div style="height: 40px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    <div class="col">
                ...
                <div style="height: 75px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    <div class="col">
                        <input name="v130" type="text" class="h-100 form-control border-0 p-0 text-center letter" placeholder="" aria-label="">
                    </div>
                </div>
                <div style="height: 75px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    <div class="col">
            ...
            <div class="col-sm-2 border-end border-dark  p-0 m-0">
                ...
                <div style="height: 40px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    ...
                    <div class="col   m-0 p-0">
                        <input name="v131" type="text" class="w-100 form-control border-1 p-0  " placeholder="" aria-label="">
                    </div>
                </div>
                ...
                <div style="height: 75px;" class="row w-100 m-0 p-0">
                    <div class="col m-0 p-0 h-100">
                        <div class="row h-50 w-100 p-0 m-0">
                            <div class="col-6 border-bottom border-end border-dark">
                                <input class="form-control form-control-sm" type="text" name="v208" placeholder="LF">
                            </div>
                            <div class="col-6 border-bottom border-dark">
                                <input class="form-control form-control-sm" type="text" name="v209" placeholder="RF">
                            </div>
                        </div>
                        <div class="row h-50 border-bottom border-dark w-100 p-0 m-0">
                            <div class="col-6 border-end border-dark">
                                <input class="form-control form-control-sm" type="text" name="v210" placeholder="LR">
                            </div>
                            <div class="col-6 ">
                                <input class="form-control form-control-sm" type="text" name="v211" placeholder="RR">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-2 border-end border-dark  p-0 m-0">
                ...
                <div style="height: 75px;" class="row w-100 m-0 p-0">
                    <div class="col m-0 p-0 h-100">
                        <div class="row h-50 w-100 p-0 m-0">
                            <div class="col-6 border-bottom border-end border-dark">
                                <input class="form-control form-control-sm" type="text" name="v212" placeholder="LF">
                            </div>
                            <div class="col-6 border-bottom border-dark">
                                <input class="form-control form-control-sm" type="text" name="v213" placeholder="RF">
                            </div>
                        </div>
                        <div class="row h-50 border-bottom border-dark w-100 p-0 m-0">
                            <div class="col-6 border-end border-dark">
                                <input class="form-control form-control-sm" type="text" name="v214" placeholder="LR">
                            </div>
                            <div class="col-6 ">
                                <input class="form-control form-control-sm" type="text" name="v215" placeholder="RR">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-2 border-end border-dark  p-0 m-0">
                ...
                <div style="height: 75px;" class="row w-100 m-0 p-0">
                    <div class="col m-0 p-0 h-100">
                        <div class="row h-50 w-100 p-0 m-0">
                            <div class="col-6 border-bottom border-end border-dark">
                                <input class="form-control form-control-sm" type="text" name="v216" placeholder="LF">
                            </div>
                            <div class="col-6 border-bottom border-dark">
                                <input class="form-control form-control-sm" type="text" name="v217" placeholder="RF">
                            </div>
                        </div>
                        <div class="row h-50 border-bottom border-dark w-100 p-0 m-0">
                            <div class="col-6 border-end border-dark">
                                <input class="form-control form-control-sm" type="text" name="v218" placeholder="LR">
                            </div>
                            <div class="col-6 ">
                                <input class="form-control form-control-sm" type="text" name="v219" placeholder="RR">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row border border-dark ">
            ...
            <div class="col-sm-2 border-end border-dark align-items-center p-0 -m-0 text-start ">
                ...
                <div style="height: 60px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    <div class="col">
                        ...
                        <input name="v141" type="date" class=" form-control border-0 p-0 text-center letter w-100" placeholder="" aria-label="">
                    </div>
                </div>
                <div style="height: 60px;" class="row border-bottom border-dark w-100 m-0">
                    <div class="col">
                        ...
                        <input name="v142" type="text" class=" form-control border-0 p-0 text-center letter" placeholder="" aria-label="">
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-2 border-end border-dark  p-0 m-0">
                ...
                <div style="height: 60px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    ...
                    <div class="col   m-0 p-0">
                        <input name="v143" type="text" class="w-100 form-control border-1 p-0  " placeholder="" aria-label="">
                    </div>
                </div>
        ...
        <div class="row border border-dark ">
            ...
            <div class="col-sm-2 border-end border-dark align-items-center p-0 -m-0 text-start ">
                ...
                <div style="height: 60px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    <div class="col">
                        ...
                        <input name="v144" type="date" class=" form-control border-0 p-0 text-center letter w-100" placeholder="" aria-label="">
                    </div>
                </div>
                <div style="height: 60px;" class="row border-bottom border-dark w-100 m-0">
                    <div class="col">
                        ...
                        <input name="v145" type="text" class=" form-control border-0 p-0 text-center letter" placeholder="" aria-label="">
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-2 border-end border-dark  p-0 m-0">
                ...
                <div style="height: 60px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    ...
                    <div class="col   m-0 p-0">
                        <input name="v146" type="text" class="w-100 form-control border-1 p-0  " placeholder="" aria-label="">
                    </div>
                </div>
        ...
        <div class="row border border-dark ">
            ...
            <div class="col-sm-2 border-end border-dark align-items-center p-0 -m-0 text-start ">
                ...
                <div style="height: 60px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    <div class="col">
                        ...
                        <input name="v147" type="date" class=" form-control border-0 p-0 text-center letter w-100" placeholder="" aria-label="">
                    </div>
                </div>
                <div style="height: 60px;" class="row border-bottom border-dark w-100 m-0">
                    <div class="col">
                        ...
                        <input name="v148" type="text" class=" form-control border-0 p-0 text-center letter" placeholder="" aria-label="">
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-2 border-end border-dark  p-0 m-0">
                ...
                <div style="height: 60px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    ...
                    <div class="col   m-0 p-0">
                        <input name="v150" type="text" class="w-100 form-control border-1 p-0  " placeholder="" aria-label="">
                    </div>
                </div>
        ...
        <div class="row border border-dark ">
            ...
            <div class="col-sm-2 border-end border-dark align-items-center p-0 -m-0 text-start ">
                ...
                <div style="height: 60px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    <div class="col">
                        ...
                        <input name="v151" type="date" class=" form-control border-0 p-0 text-center letter w-100" placeholder="" aria-label="">
                    </div>
                </div>
                <div style="height: 60px;" class="row border-bottom border-dark w-100 m-0">
                    <div class="col">
                        ...
                        <input name="v152" type="text" class=" form-control border-0 p-0 text-center letter" placeholder="" aria-label="">
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-2 border-end border-dark  p-0 m-0">
                ...
                <div style="height: 60px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    ...
                    <div class="col   m-0 p-0">
                        <input name="v153" type="text" class="w-100 form-control border-1 p-0  " placeholder="" aria-label="">
                    </div>
                </div>
        ...
        <div class="row border border-dark ">
            ...
            <div class="col-sm-2 border-end border-dark align-items-center p-0 -m-0 text-start ">
                ...
                <div style="height: 60px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    <div class="col">
                        ...
                        <input name="v153" type="date" class=" form-control border-0 p-0 text-center letter w-100" placeholder="" aria-label="">
                    </div>
                </div>
                <div style="height: 60px;" class="row border-bottom border-dark w-100 m-0">
                    <div class="col">
                        ...
                        <input name="v154" type="text" class=" form-control border-0 p-0 text-center letter" placeholder="" aria-label="">
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-2 border-end border-dark  p-0 m-0">
                ...
                <div style="height: 60px;" class="row border-bottom border-dark w-100 m-0 p-0">
                    ...
                    <div class="col   m-0 p-0">
                        <input name="v155" type="text" class="w-100 form-control border-1 p-0  " placeholder="" aria-label="">
                    </div>
                </div>
