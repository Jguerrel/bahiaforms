...
<form name="vehicleform" id="vehicleform" method="post" action="{{ route('vehicleform.store') }}">
    ...
    <div class="container border border-dark ">
        ...
        <div class="row border border-dark ">
            <div class="col-sm-3 border-end border-dark align-items-center p-1 text-start ">
                <input name="v114" value="{{$request->chasis}}" type="date" class=" form-control border-0 p-0 text-center letter w-100" placeholder="" aria-label="">
            </div>

            <div class="col-sm-2 border-end border-dark align-items-center p-1 text-center">
                <input name="v115" value="{{$request->modelo}}" type="text" class="h-100 form-control border-0 p-0 text-center letter" placeholder="" aria-label="">
            </div>
            <div class="col-sm-2 border-end border-dark align-items-center p-1 text-center">
                <input name="v116" type="text" class="h-100 form-control border-0 p-0 text-center letter" placeholder="" aria-label="">
            </div>
            <div class="col-sm-3  border-end border-dark align-items-center p-1 text-center">
                <input name="v117" value="{{$request->chasis}}" type="text" class="h-100 form-control border-0 p-0 text-center letter" placeholder="" aria-label="">
            </div>
            <div class="col-sm-2 border-end border-dark align-items-center p-1 text-center">
                <input name="v118" type="date" class=" form-control border-0 p-0 text-center letter w-100" placeholder="" aria-label="">
            </div>
        </div>
    </div>
    <br>
